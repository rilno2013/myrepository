    ...
    <?php $this->load->view('vwsidebar')?>
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active">
                            <a href="javascript:;" onclick="location.reload()"><strong>/Sasan Sai</strong></a>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <button class="btn btn-primary" type="button" data-toggle="modal" data-target=".modal-add-stock"><i class="fa fa-plus"></i>Sasan Sai</button>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Input Sasan Sai</h5>
              ...
              <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select type="text" class="form-control" id="kodigu" name="kodigu">
                                ...
                                <?php
                                    foreach($sasan as $st){
                                        echo "<option value='".$st['id_sasan']."'>".$st['id_sasan']."-".$st['naran_sasan']."-".$st['marka']."-".$st['tipu_sasan']."</option>";
                                    }
                                ?>
                            </select> 
                        </div>
                    ...
                    <div class="col-lg-6">
                            <div class="form-group">
                                <label for="message-text" class="col-form-label">Data Sai:</label>
                                <input type="date" class="form-control" id="data_sai" name="data_sai" value="<?php echo date('Y-m-d')?>">
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Autor[Input Dadus]:</label>
                                <input type="text" class="form-control" id="autor" name="autor" value="<?php echo $this->session->userdata('username')?>" readonly>
                            </div>
                            <div class="form-group">
        ...
        <div class="modal fade modal-edit-stock" id="exampleModalx" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Sasan Sai</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ...
              <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                            <div class="form-group">
                                <label for="message-text" class="col-form-label">Data Sai:</label>
                                <input type="date" class="form-control" id="data_saiedit" name="data_sai" value="<?php echo date('Y-m-d')?>">
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Autor[Input Dadus]:</label>
                                <input type="text" class="form-control" id="autoredit" name="autor" value="<?php echo $this->session->userdata('username')?>">
                            </div>
                            <div class="form-group">
                                <label for="message-text" class="col-form-label">Fo Husi:</label>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: red; color: white;">
                        ...
                        <p class="modal-title">Delete Sasan Sai</p>
                    </div>
                    <div class="modal-body">
    ...
    <script>
        $(document).ready(function(){
            ...
            $("form#myaddform").submit(function(e){
                ...
                if($("#kodigu").val()==null){alert("Favor prense kodigu sasan!");$("#kodigu").focus(); return false; }
                ...
                if($("#data_sai").val()==""){alert("Favor prense data sai!"); $("#data_sai").focus(); return false; }
                ...
                $.ajax({
                    ...
                    type  :"POST",
                    url   :"<?php echo base_url('sasansai/fn_addsasan') ?>",
                    data  : formData,
                    cache : false,
                    processData:false,
                    contentType:false,
            ...
            $("form#myeditform").submit(function(e){
                ...
                $.ajax({
                    ...
                    type  :"POST",
                    url   :"<?php echo base_url('sasansai/fn_editsasan') ?>",
                    data  : formData,
                    cache : false,
                    processData:false,
                    contentType:false,
        ...
        function fn_editsasan(id){
            $.ajax({
                type:"POST",
                url:"<?= base_url('sasansai/fn_getsasanbyid')?>",
                dataType:"json",
                data:{idx:id},
        ...
        function fn_deletedata(){
            ...
            $.ajax({
                type : "POST",
                url : "<?= base_url('sasansai/fn_delete')?>",
                dataType: "text",
